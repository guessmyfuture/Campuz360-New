package com.airmate.campuz360.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("campuz360");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("campuz360");
        ...
        config.getMapConfigs().put("com.airmate.campuz360.domain.*", initializeDomainMapConfig(jHipsterProperties));
